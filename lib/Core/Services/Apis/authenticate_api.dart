...
//           (nav) => Navigator.pushReplacementNamed(context, "/authenticateView")
//               .catchError(
//             (error) => print(error.code),
//           ),
//         );
...
// Future<void> signInWithEmailAddress(UserModel userModel,
//     AuthNotifier authNotifier, BuildContext context) async {
//   await FirebaseAuth.instance
//       .signInWithEmailAndPassword(
//           email: userModel.userEmail, password: userModel.userPassword)
//       .then((result) async {
//     if (result != null) {
//       authNotifier.setUser(result.user);
//       return Navigator.pushReplacementNamed(context, "/homeView");
//     } else {
...
// Future<void> signUpWithEmailAddress(AuthNotifier authNotifier,
...
//     });
//   } else {
//     print("A user hasn't been Logged Out Yet");
//     return;
//   }
// }
